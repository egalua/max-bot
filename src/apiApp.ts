...
const photoName = 'photo_2026-02-05_12-21-01.jpg'
const photoPath = './test_data/' + photoName
...
await maxBot.sendMessageToUser(userID, message1)
await maxBot.sendMessageToUser(userID, message2)
await maxBot.sendMessageToUser(userID, "фото", [imageAtachment])
await maxBot.sendMessageToUser(userID, "файл", [fileAtachment])


await maxBot.sendMessageToChat(chatID, message1)
await maxBot.sendMessageToChat(chatID, message2)
await maxBot.sendMessageToChat(chatID, "фото", [imageAtachment])
await maxBot.sendMessageToChat(chatID, "файл", [fileAtachment])
